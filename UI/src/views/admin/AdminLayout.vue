...
import { User, Key, Check, Bell, Back, Menu, Close, Message, Collection, PriceTag } from '@element-plus/icons-vue'
...
const menuItems = computed(() => ([
  ...
  { index: '/admin/messages', title: '消息中心', icon: Message, permissionCode: 'admin.feedback' },
  ...
  { index: '/admin/tags', title: '标签管理', icon: PriceTag, permissionCode: 'admin.tag' },
